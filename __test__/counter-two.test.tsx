...
describe('Testing of Counter function', () => {
    ...
    it('Handlers are called', async () => {
        ...
        render(<CounterTwo counter={0} handleDecreament={decrementHandler} handleIncreament={incrementHandler} />);
        
        const increamentCounterButton = screen.getByRole('button', { name: 'Increament' });
        const decreamentCounterButton = screen.getByRole('button', { name: 'Decreament' });
