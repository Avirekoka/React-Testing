...
export default function Home() {
  ...
  return (
    <>
      ...
      <div>
        {showText && <span>This is my hidden text</span>}<br></br>
        <button onClick={() => setShowText(!showText)}>Show Text</button>
        <button onClick={() => {
          setTimeout(() => {
            setShowText(!showText)
          }, 12000)
        }}>Asynchronous Click</button>

        <h1>This is my user details</h1>
        <UserComponent name="Avinash" userName="AvkNash" email="avi1999kokare@gmail.com" isEmailVarified={true} />
        <UserList />
